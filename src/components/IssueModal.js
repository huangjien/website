    ...
    <>
      {action === "edit" && (
        <Button className="bg-transparent" onClick={handleOpen}>
          <BiEdit data-testid="edit-icon" className="h-8 w-8 bg-transparent text-primary" />
        </Button>
      )}
      {action === "new" && (
        <Button className="bg-transparent" onClick={handleOpen}>
          <BiListPlus data-testid="list-plus-icon" className="h-8 w-8 bg-transparent text-primary" />
        </Button>
      )}
          ...
          <DialogBody>
            <div>
              <div className="lg:inline-flex align-middle w-full justify-evenly gap-4 m-2">
                ...
                />
                <CheckboxGroup label={"Select Tags"} className="m2 w-1/2" orientation="horizontal">
