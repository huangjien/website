...
jest.mock('@heroui/react', () => ({
  ...
  DropdownMenu: ({ children, onAction }) => {
    return (
      <div data-testid="dropdown-menu" data-onaction={onAction ? 'true' : 'false'}>
...
describe('Login Component', () => {
  ...
  it('should render user dropdown when authenticated', () => {
    ...
    expect(screen.getByTestId('user-description')).toHaveTextContent('john@example.com');
    expect(screen.getByTestId('user-avatar')).toHaveAttribute('data-src', 'https://example.com/avatar.jpg');
  });
  ...
  it('should call signOut when logout is selected', async () => {
    ...
    const logoutItem = Array.from(screen.getAllByTestId('dropdown-item')).find(item => 
  ...
  it('should handle settings action', async () => {
    ...
    const settingsItem = Array.from(screen.getAllByTestId('dropdown-item')).find(item => 
      item.getAttribute('data-action') === 'settings'
    );
  ...
  it('should handle dropdown section correctly', () => {
    ...
    expect(screen.getByTestId('section-title')).toHaveTextContent('login.actions');
  });
