...
jest.mock('@heroui/react', () => ({
  Input: ({ label, placeholder, value, onChange, type, min, max, step, className, ...props }) => (
  ...
  Select: ({ label, placeholder, selectedKeys, onSelectionChange, className, children }) => (
...
describe('ConfigurationTab Component', () => {
  ...
  it('should render all configuration inputs', () => {
    ...
    expect(screen.getByTestId('select-label')).toHaveTextContent('ai.select_model');
  ...
  it('should call setTemperature when temperature input changes', async () => {
    ...
    render(<ConfigurationTab {...defaultProps} setTemperature={mockSetTemperature} />);
  ...
  it('should call setTrackSpeed when track speed input changes', async () => {
    ...
    render(<ConfigurationTab {...defaultProps} setTrackSpeed={mockSetTrackSpeed} />);
  ...
  it('should display correct placeholders using translation keys', () => {
    ...
    expect(selectElement.querySelector('option[disabled]')).toHaveTextContent('ai.select_model');
    
    expect(screen.getByPlaceholderText('ai.value_range_0_1')).toBeInTheDocument();
    expect(screen.getByPlaceholderText('ai.value_range_50_500')).toBeInTheDocument();
  });
