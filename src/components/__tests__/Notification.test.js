...
describe('Notification Functions', () => {
  ...
  describe('success function', () => {
    ...
    it('should handle long message', () => {
      const message = 'This is a very long success message that contains multiple words and should be handled properly by the notification system';
    ...
    it('should handle message with special characters', () => {
      const message = 'Success! 🎉 Operation completed with 100% accuracy & efficiency.';
  ...
  describe('multiple function calls', () => {
    ...
    it('should handle mixed notification types', () => {
      ...
      expect(toast.warn).toHaveBeenCalledWith('Warning message', { autoClose: 8000 });
      expect(toast.error).toHaveBeenCalledWith('Error message', { autoClose: false });
