...
jest.mock('../../locales/i18n', () => ({
  languages: [
    { key: 'en', value: 'English', languageCode: 'en-US', name: 'en-US-Standard-A' },
    { key: 'zh_CN', value: '中文(简体)', languageCode: 'cmn-CN', name: 'cmn-CN-Standard-A' },
    { key: 'es', value: 'Español', languageCode: 'es-ES', name: 'es-ES-Standard-A' },
  ],
}));
...
jest.mock('@heroui/react', () => ({
  ...
  DropdownItem: ({ children, 'data-key': dataKey }) => (
    <div data-testid="dropdown-item" data-key={dataKey}>{children}</div>
  ),
