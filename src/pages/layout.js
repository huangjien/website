...
export default function RootLayout({ children }) {
  ...
  return (
    <div className='min-h-screen flex flex-col grain'>
      ...
      <footer
        role='contentinfo'
        className='border-t border-border/60 mt-8 py-6 text-sm text-muted-foreground'
      >
        <div className='container-prose flex flex-wrap items-center justify-between gap-x-5 gap-y-2'>
          <nav
          ...
          <p className='text-xs text-muted-foreground/80 num-tabular whitespace-nowrap sm:mr-14'>
