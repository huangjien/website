...
jest.mock('@heroui/react', () => ({
  ...
  Input: ({ value, onChange, onValueChange, placeholder, startContent, isClearable, className }) => (
  ...
  Pagination: ({ total, page, onChange, isCompact, showControls, showShadow, color }) => (
...
describe('Settings Page Component', () => {
  ...
  it('should render table with settings data', () => {
    ...
    expect(screen.getByTestId('table')).toHaveAttribute('aria-label', 'Settings');
