...
describe('About page', () => {
  ...
  it('should display about content from useGithubContent', () => {
    ...
    expect(markdownElement).toHaveTextContent('# About Me This is my personal website.')
  })
...
\`\`\`
    ...
    const markdownElement = screen.getByTestId('markdown-content')
    expect(markdownElement).toHaveTextContent('# Main Title ## Subtitle **Bold text** and *italic text* - List item 1 - List item 2 [Link](https://example.com) ```javascript console.log(\'code block\'); ```')
  })
